...
public class MenuOneFragment extends Fragment {
    GridView gridView;
    View rootView;
    String[] title={"Pendaftaran Online","Riwayat Periksa","Antrian","Dokter Hari Ini","Pendaftaran Poli Covid","Jadwal Dokter"};
    int[] image={R.drawable.icons8newticket96,R.drawable.icons8orderhistory80,R.drawable.antrian,R.drawable.icons8doctormale96,R.drawable.covid,R.drawable.icons8info80};
